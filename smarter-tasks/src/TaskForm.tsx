    ...
    render(){
        return(
            ...
            <form className="border flex-row" onSubmit={this.addTask} >
                <input className="border" type="text" id="todoTitle" ref={this.inputRef} value = {this.state.title} onChange={this.titleChanged}/>
                 <input className ="border" type="text" id="todoDescription" ref={this.inputRef} value = {this.state.description} onChange ={this.descriptionChanged} />
                 <input className ="border" type="date" id="todoDueDate" ref={this.inputRef} value ={this.state.dueDate} onChange ={this.dateChanged} />
